                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
                        <ul class="space-y-1 px-2">
                            ...
                            <!-- Example two level -->
                            <x-layouts.sidebar-two-level-link-parent title="To-Do" icon="fas-book"
                                :active="request()->routeIs('two-level*')">
                                <x-layouts.sidebar-two-level-link href="{{ route('todos.create') }}" icon='fas-pencil'
                                    :active="request()->routeIs('to-do.new-todo*')">Nueva Tarea</x-layouts.sidebar-two-level-link>
                                <x-layouts.sidebar-two-level-link href="{{ route('todos.index') }}" icon='fas-clipboard-list'
                                    :active="request()->routeIs('todos.index*')">Listado</x-layouts.sidebar-two-level-link>
